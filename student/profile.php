        ...
        <div class="page-breadcrumb bg-white">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">View Profile - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></h4>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <center class="mt-4">
                        <?php
                        if ($myavatar == NULL) {
                            print '  <img class="rounded-circle" width="150" src="../assets/images/' . $mygender . '.png" alt="' . $sdfname . '">';
                        } else {
                            echo '<img class="rounded-circle" src="data:image/jpeg;base64,' . base64_encode($myavatar) . '" width="150" alt="' . $sdfname . '"/>';
                        }

                        ?>
                        <!-- <img src="../../assets/images/users/5.jpg" class="rounded-circle" width="150"> -->
                        <h4 class="card-title mt-2"><?php echo "$myfname"; ?> <?php echo "$sdlname"; ?></h4>
                        <h6 class="card-subtitle">Department of <?php echo $mydepartment; ?> </h6>
                        <div class="row text-center justify-content-md-center">
                            <div class="col-4">
                                <a href="javascript:void(0)" class="link"><i class="icon-people"></i>
                                    <font class="font-weight-medium">Role : <?php echo ucwords("$myrole"); ?></font>
                                </a>
                            </div>
                            <div class="col-4">
