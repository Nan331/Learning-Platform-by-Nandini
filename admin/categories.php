                                                ...
                                                <div id="zero_config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            $offset = ($page - 1) * $limit;
                                                            $dep_query = "SELECT * FROM `tbl_categories` ORDER BY category_id DESC LIMIT $offset, $limit";
                                                                ...
                                                                <table id="zero_config" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="zero_config_info">
                                                                    <thead>
                                                                        <tr role="row">
                                                                            ...
                                                                            <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 0px;">Category</th>
                                                                            <th class="sorting_desc" tabindex="0" aria-controls="zero_config" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 0px;" aria-sort="descending">Status</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 0px;">Department</th>
                                                                        ...
                                                                        ?>
                                                                            <tr role="row" class="odd">
                                                                                ...
                                                                                <?php if ($row['status'] == "Active") { ?>
                                                                                    <td><a href="pages/make_ct_in.php?id=<?php echo $row['category_id']; ?>"><span class="badge rounded-pill bg-warning">deactivate</span></a></a></td>
                                                                                <?php } elseif ($row['status'] == "Inactive") { ?>
                                                                                    <td><a href="pages/make_ct_ac.php?id=<?php echo $row['category_id']; ?>"><span class="badge rounded-pill bg-success">activate</span></a></a></td>
                                                                                <?php } else { ?>
                                                                                    <td><?php echo 'No Status'; ?></td>
                                                                                <?php } ?>
                                                                                <td><a href="pages/drop_ct.php?id=<?php echo $row['category_id']; ?>"><span class="badge rounded-pill bg-danger">delete</span></a></td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-md-7">
                                                            <div class="dataTables_paginate paging_simple_numbers" id="zero_config_paginate">
                                                                ...
                                                                $dep_query1 = "SELECT * FROM `tbl_categories`";
                                                                ...
                                                                if (mysqli_num_rows($result1) > 0) {
                                                                    ...
                                                                    if ($page > 1) {
                                                                        echo '<li class="paginate_button page-item previous" id="zero_config_previous"><a href="categories.php?page=' . ($page - 1) . '" aria-controls="zero_config" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li>';
                                                                    }
                                                                    for ($i = 1; $i < $total_pages; $i++) {
                                                                        ...
                                                                        echo '<li class="paginate_button page-item ' . $active . '"><a href="categories.php?page=' . $i . '" aria-controls="zero_config"  class="page-link">' . $i . '</a></li>';
                                                                    }
                                                                    if ($total_pages > $page) {
                                                                        echo '<li class="paginate_button page-item next" id="zero_config_next"><a href="categories.php?page=' . ($page + 1) . '" aria-controls="zero_config" data-dt-idx="7" tabindex="0" class="page-link">Next</a></li>';
                                                                    }
                                                                    echo '</ul>';
