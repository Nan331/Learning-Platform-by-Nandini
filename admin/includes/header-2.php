        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
            ...
            <ul class="navbar-nav ms-auto d-flex align-items-center">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark show" href="#" data-bs-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="true">
                        <?php
                            
                                echo '<img class="rounded-circle" width="36" src="data:image/jpeg;base64,' . base64_encode($myavatar) . '" class="thumb-lg img-circle"  alt="' . $myfname . '"/>';
                        
                            ?>
                        <span class="ms-2 font-weight-medium"> <?php echo "$myfname"; ?></span><span
                    ...
                    ">
                            <div class="">
                                <?php
                                    if ($myavatar == NULL) {
                                        print ' <img class="rounded-circle" width="60" src="../assets/images/' . $sdgender . '.png" alt="' . $myfname . '">';
                                    } else {
                        ...
                        <a class="dropdown-item" href="profile.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <a class="dropdown-item" href="edit-profile.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="feather feather-settings feather-sm text-warning me-1 ms-1">
                            ...
                            Account Setting</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
